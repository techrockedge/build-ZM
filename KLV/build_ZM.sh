...
##### Install ZoneMinder in KLV
##
##

# Update repo db and packages
xbps-install -Suy
...
useradd -padmin -s /bin/bash www-data
...
xbps-install -y perl-YAML perl-DBD-mysql perl-DBI perl-Date-Manip
xbps-install -y perl-DateTime perl-LWP perl-WWW-Curl 
...
# check where create sql file is and go there
